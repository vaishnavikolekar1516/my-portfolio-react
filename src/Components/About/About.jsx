  ...
  return (
    <section id="about" className="about-section">
      ...
      <div className="about-container">
        ...
        <div className="about-image">
          <div className="image-wrapper">
            <img src={profile_img1} alt="Vaishnavi Kolekar" />
          </div>
        </div>
        ...
        <div className="about-content">
          ...
          <h2>
            Crafting Modern <span>Web Experiences</span>
          </h2>

          <p>
            I am a MERN Stack Developer experienced in building responsive,
            scalable and performance-driven web applications using React,
            Node.js, Express and MongoDB.
          </p>

          <p>
            I focus on clean architecture, maintainable code and intuitive
            UI design to deliver digital solutions that align with both
